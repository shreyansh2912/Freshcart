...
function AddCategory() {
   ...
   let handleSub = async ()=>{
      let response = await axios.post("http://localhost:8081/Addcategory",category);
               ...
               <div className="row mb-8">
                  <div className="col-md-12">
                     <div className="d-md-flex justify-content-between align-items-center">
                        ...
                        <div>
                           <a href="/Categories" className="btn btn-light">Back to Categories</a>
                        </div>
                     </div>
                  </div>
               </div>
                           ...
                           <div className="row">
                              ...
                              <div className="mb-3 col-lg-12 mt-5">
                                 ...
                                 <div className="mb-3">
                                    ...
                                    <input type="text" className="form-control" placeholder="Title" onChange={data} name='metaTitle' />
                                 </div>

                                 {/* <!-- input --> */}
                                 <div className="mb-3">
                                    <label className="form-label">Meta Description</label>
                                    <textarea className="form-control" rows="3" onChange={data} placeholder="Meta Description" name='metaDesc'></textarea>
                                 </div>
                              </div>
