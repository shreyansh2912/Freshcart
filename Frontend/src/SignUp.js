...
function SignUp() {
   ...
   //  req.open("POST","http://127.0.0.1:8081/Addusers");
                     ...
                     <form class="needs-validation" novalidate>
                        <div class="row g-3">
                           ...
                           <div class="col">
                              ...
                              <input type="text" class="form-control" id="formSignupfname" name='name' placeholder="Name" onChange={handleChange} required />
                              <div class="invalid-feedback">Please enter first name.</div>
                           </div>
                           <div class="col">
                              {/* <!-- input --> */}
                              <label for="formSignuplname" class="form-label visually-hidden">Last Name</label>
                              <input type="text" class="form-control" id="formSignuplname" name='username' placeholder="Username" onChange={handleChange} required />
                              <div class="invalid-feedback">Please enter last name.</div>
                           </div>
                           <div class="col-12">
                              {/* <!-- input --> */}
                              <label for="formSignupEmail" class="form-label visually-hidden">Email address</label>
                              <input type="email" class="form-control" id="formSignupEmail" name='email' placeholder="Email" onChange={handleChange} required />
                           ...
                           <div class="col-12">
                              <div class="password-field position-relative">
                                 ...
                                 <div class="password-field position-relative">
                                    <input type="password" class="form-control fakePassword" name='password' id="formSignupPassword"  onChange={handleChange} placeholder="*****" required />
                           ...
                           {/* <!-- btn --> */}
                           <div class="col-12 d-grid"><button type="button" class="btn btn-primary" onClick={handleSub}>Register</button></div>
