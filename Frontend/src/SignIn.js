...
function SignIn() {
   ...
   let user_Auth = useContext(AppContext);
   let user_Id = useContext(UserContext);
   let tag = document.getElementsByClassName("hide")[0];
   ...
   const handleSub = async ()=>{
      let resdata = await axios.post("http://localhost:8081/login",data);
         if(resdata.data[0]){
            setrole(resdata.data[0].role_as)
            setname(resdata.data[0].name)
            localStorage.setItem("uid",resdata.data[0].id);
            localStorage.setItem("role",resdata.data[0].role_as);
            user_Auth[0] = "false";
            user_Id[0] = resdata.data[0].id;
            if(resdata.data[0].role_as == 1){
               // nav("/admin");
  ...
  return (
    <div>
      ...
      <div className='w-25 hide container bg-light mt-3' style={{padding:"8px", borderRadius:"10px" ,boxShadow:"10px 10px black" , display:"none"}}>
         <div className='container   text-center pt-2' style={{alignContent:"center", border:"3px solid green",borderRadius:"10px"}}>
            {name != "" ?
            <h5>Welcome Back, <span style={{fontWeight:"700",color:"green",fontSize:"20px",fontFamily:"cursive"}}>{name}</span> </h5>
             :
      ...
      <main>
         {/* <!-- section --> */}
         <section className="my-lg-10 my-8">
                     ...
                     <form className="needs-validation" noValidate>
                        <div className="row g-3">
                           ...
                           <div className="col-12">
                              ...
                              <input type="email" className="form-control" id="formSigninEmail" name='email' onChange={handleChange} placeholder="Email" required />
                           ...
                           <div className="col-12">
                              ...
                              <div className="password-field position-relative">
                                 ...
                                 <div className="password-field position-relative">
                                    <input type="password" className="form-control fakePassword" name='password' onChange={handleChange} id="formSigninPassword" placeholder="*****" required />
                           ...
                           {/* <!-- btn --> */}
                           <div className="col-12 d-grid" onClick={handleSub}><button type="button"  className="btn btn-primary">Sign In</button></div>
                           {/* <!-- link --> */}
                           <div>
                  ...
                  <div className="col-lg-7 mt-4 mt-md-0">
                     <ul className="list-inline mb-0 text-lg-end text-center">
                        ...
                        <li className="list-inline-item ms-4">
                           <a href="#!"><img src="../assets/images/appbutton/appstore-btn.svg" alt="" style={{width:140+"px"}}/></a>
                        </li>
                        <li className="list-inline-item">
                           <a href="#!"><img src="../assets/images/appbutton/googleplay-btn.svg" alt="" style={{width:140+"px"}} /></a>
                        </li>
                     </ul>
                  </div>
               </div>
